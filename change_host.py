...
if data[11] == 'HOST = "https://white-reminder.herokuapp.com"\n':
    data[11] = 'HOST = "http://127.0.0.1:8000"\n'
else:
    data[11] = 'HOST = "https://white-reminder.herokuapp.com"\n'
...
if data[110] == 'var HOST = "https://white-reminder.herokuapp.com"\n':
    data[110] = 'var HOST = "http://127.0.0.1:8000"\n'
else:
    data[110] = 'var HOST = "https://white-reminder.herokuapp.com"\n'
